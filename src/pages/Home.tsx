...
import { FiImage, FiUpload, FiCameraOff } from 'react-icons/fi';
import Loader from '../components/Loader';
import type { Image } from '../models/images';

const Home = () => {
  const { images, loading, error, hasMore } = useAppSelector((state) => state.images);
          ...
          {!loading && images.length === 0 && (
            ...
            >
              ...
              <p className="text-gray-500 max-w-md">
                Upload your first image by clicking the upload button above
              </p>
              <motion.button
                onClick={() => setIsUploadModalOpen(true)}
                whileHover={{ scale: 1.03 }}
